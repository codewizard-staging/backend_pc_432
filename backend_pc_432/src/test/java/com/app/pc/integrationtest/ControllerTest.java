package com.app.pc.integrationtest;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("pc", n.getAttribute("Namespace"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM pc.PetService");
    jdbcTemplate.execute("DELETE FROM pc.PetOwner");
    jdbcTemplate.execute("DELETE FROM pc.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM pc.Manager");
    jdbcTemplate.execute("DELETE FROM pc.Document");
    jdbcTemplate.execute("DELETE FROM pc.Pet");
     jdbcTemplate.execute("DELETE FROM pc.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM pc.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM pc.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM pc.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM pc.PetCareCenterPets");
